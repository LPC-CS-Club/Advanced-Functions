...
private:
    ...
    Student deserialize_student(const std::vector<std::byte> &, std::size_t index &) const;
    Assignment deserialize_assignment(const std::vector<std::byte> &, std::size_t index &) const;
    std::string deserialize_string(const std::vector<std::byte> &, std::size_t index &) const;
    double deserialize_double(const std::vector<std::byte> &, std::size_t index &) const;
